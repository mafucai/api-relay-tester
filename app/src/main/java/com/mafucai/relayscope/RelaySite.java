...
public final class RelaySite {
    ...
    public RelaySite(String name, String baseUrl, String apiKey, String priceUrl) {
        this(name, baseUrl, apiKey, priceUrl, "");
    }

    public RelaySite(String name, String baseUrl, String apiKey, String priceUrl, String group) {
    ...
    public static RelaySite fromJson(JSONObject object) {
        return new RelaySite(object.optString("name"), object.optString("base_url"), object.optString("api_key"), object.optString("price_url"), object.optString("group"));
    }
}
