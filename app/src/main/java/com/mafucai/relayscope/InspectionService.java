...
public final class InspectionService extends Service {
    ...
    @Override public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        group = intent == null ? "" : intent.getStringExtra("inspection_group");
        if (group == null) group = "";
